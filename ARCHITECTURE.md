...
- [`agentforge-clinical-agent`](https://www.npmjs.com/package/agentforge-clinical-agent) npm package — reusable clinical query agent with mock and FHIR data sources
